...
class Visualiser(LocationObserverAbstract):
	...
	def paint(self):
                ...
                self.canvas.create_line(25,25,475,475, fill="#DDDDDD", width=3) #diagonal marking
                self.canvas.create_oval(200,200,300,300, outline="#DDDDDD", width=3) #circle marking
                for o in self.objectList():
                        ...
                        if objectType == "pole":
                                ...
                                self.canvas.create_rectangle(o.x,self.courseHeight - o.y,o.x+o.width,self.courseHeight - (o.y+o.height), fill="black")
                                ...
                                self.canvas.create_line(o.x,self.courseHeight - o.y,o.width,self.courseHeight - o.height,fill="black", width=1)
                ...
                self.canvas.create_text(30,520, text="\n Bearing:\n {0:.2f}\n".format(self.chariotBearing))
                self.canvas.create_text(30,550, text="\n Position:\n x={}\n y={}".format(self.chariotx,self.charioty))
