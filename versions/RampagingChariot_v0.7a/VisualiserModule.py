...
class Visualiser(LocationObserverAbstract):
	...
	def paint(self):
                ...
                self.canvas.create_line(180, 740, 180, 690, fill="#DDDDDD", width=4)
                self.canvas.create_line(300, 740, 300, 690, fill="#DDDDDD", width=4)
                ...
                self.canvas.create_text(55,545, font="Sans 9", text="\n Bearing: {0:.1f} deg\n".format(self.chariotBearing))
                self.canvas.create_text(54,560, font="Sans 9", text="\n Position:\n x= {0:.1f} y= {0:.1f}".format(self.chariotx,self.charioty))
